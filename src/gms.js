...
function search(text) {
    ...
    const describes = [
        ...
        ["7", "pb", "pink bean", "yeti", "orange mushroom", "slime", "race", "track", "school", "trophy", "gold"],
        ...
        ["12", "pb", "pink bean", "balrog", "pepe", "pig", "colosseum", "slime", "anniversary"],
        ["75", "black bean", "yeti", "pepe", "orange mushroom", "ribbon pig", "mu gong", "wooden mask", "kemdi", "halloween", "jason", "mask", "beware", "thursday", "12th"],
        ["13", "pb", "pink bean", "von leon", "evan", "pig", "orange mushroom", "pepe", "ickhart", "hotel", "building", "anniversary"],
        ["54", "pb", "pink bean", "yeti", "slime", "koc", "mihile", "xmas", "christmas", "winter", "star"],
        ["55", "pb", "pink bean", "pepe", "slime", "red snail", "carnival", "ride", "drop", "theme park", "amusement"],
        ["56", "pb", "pink bean", "pepe", "orange mushroom", "slime", "yeti", "onion", "ragora", "dracula", "vampire", "halloween", "candles", "pictures"],
        ...
        ["72", "grandis", "flora", "ark", "specter", "abyss"],
        ["24", "grandis", "flora", "adele", "ether sword"],
        ["25", "grandis", "flora", "adele", "jerome"],
        ["26", "grandis", "anima", "lara"],
        ["62", "grandis", "anima", "lara", "slime", "pb", "pink bean", "rock spirits", "field"],
        ["63", "grandis", "anima", "lara", "hy", "ho young", "slime", "pb", "pink bean", "pepe", "yeti", "taotie", "fireworks", "lantern"],
        ["71", "hy", "hoyoung", "taotie", "cloud", "mount", "songyu"],
        ["27", "grandis", "senya"],
        ...
        ["64", "yeti", "orange mushroom", "pepe", "xmas", "christmas", "winter", "explorers", "piano", "tree", "presents", "star", "moon"],
        ...
        ["36", "grandis", "nova", "angelic buster", "kaiser", "moonbeam", "13", "mapleverse", "space", "alien", "anniversary", "star squad"],
        ...
        ["65", "orchid", "rabbit", "slime", "fireworks", "cute"],
        ["66", "explorers", "pirate", "ship", "flag", "sail", "sea", "orange mushroom", "rock spirits", "yeti", "pb", "pink bean"],
        ...
        ["48", "beautyroid", "wondroid", "atelier", "mechanical utopia", "mechanical hearts"],
        ["73", "beautyroid", "wondroid", "atelier", "mechanical utopia", "mechanical hearts"],
        ...
        ["74", "sengoku", "akechi mitsuhide", "asura war"],
        ["59", "neo", "tokyo", "aufheben", "asia", "dunas", "ashray", "zipangu", "japan"],
        ["67", "bt", "beast tamer", "chase", "fort", "arby", "lai", "eka", "forest"],
        ["68", "bt", "beast tamer", "chase", "fort", "arby", "lai", "eka", "bridge", "river"],
        ["69", "jett", "spaceship"],
        ["70", "jett", "spaceship"],
        ["53", "purrfect rangers", "cat", "pyramid", "sphinx", "sphynx", "ufo", "spaceships"],
        ["57", "purrfect rangers", "cat", "turtle", "wave", "presents", "flowers", "surf", "slime"],
        ["58", "purrfect rangers", "cat", "laser", "earth", "wheel", "truck", "santa"],
        ["60", "home", "my home", "house", "jenny", "cafe", "beach", "terrace", "register", "surfboard", "coffee", "juice", "cat", "pb", "pink bean"],
        ["61", "home", "my home", "house", "jenny", "amy", "alvin", "mansion", "querencia"]
    ]
